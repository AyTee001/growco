...
3. Ми працюємо з Angular Material (<https://material.angular.dev/>) з кастомною кольоровою темою, тому треба використовувати саме Angular Material, якщо є якийсь компонент, який нам підходить.
